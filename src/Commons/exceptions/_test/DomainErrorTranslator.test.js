...
describe('DomainErrorTranslator', () => {
  it('should translate error correctly', () => {
    ...
    expect(DomainErrorTranslator.translate(new Error('ADD_THREAD.NOT_MEET_DATA_SPECIFICATION')))
    ...
    expect(DomainErrorTranslator.translate(new Error('ADD_COMMENT.NOT_MEET_DATA_SPECIFICATION')))
