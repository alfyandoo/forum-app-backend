...
DomainErrorTranslator._directories = {
  ...
  'ADD_THREAD.NOT_MEET_DATA_SPECIFICATION': new InvariantError('tidak dapat membuat thread baru karena tipe data tidak sesuai'),
  ...
  'ADD_COMMENT.NOT_MEET_DATA_SPECIFICATION': new InvariantError('tidak dapat membuat comment baru karena tipe data tidak sesuai'),
};
